...
export const Collapse: React.FC<CollapseProps> = ({ title, content }) => {
  return (
    <div className="w-[55%] mx-auto font-rubik text-left">
      <br className="text-lightRed" />
      <details className="collapse collapse-arrow bg-base-200 bg-transparent">
        <summary className="collapse-title text-2xl font-bold text-left transition hover:text-lightRed border-t-4 max-md:border-t-1 max-md:text-sm">
          {title}
        </summary>
